    ...
    <div className="navbar relative  pb-12 text-github-white-link lg:pb-24">
      <div className="mx-auto max-w-screen-xl px-3 py-6">
        ...
        <div>
          ...
          >
            <path
              d="M0,40L21.8,32C43.6,24,87,8,131,16C174.5,24,218,56,262,56C305.5,56,349,24,393,24C436.4,24,480,56,524,56C567.3,56,611,24,655,24C698.2,24,742,56,785,64C829.1,72,873,56,916,56C960,56,1004,72,1047,56C1090.9,40,1135,0,1178,0C1221.8,0,1265,40,1309,56C1352.7,72,1450,64,1450,64"
